...
[ENG] Usage:
  node src/cli.js <keywords> [intent] [limit]
...
[JPN] 使い方:
  node src/cli.js <検索キーワード> [検索意図] [最大件数]
...
[ENG] Example:
  node src/cli.js "Banksy" "Extract exhibition schedule and ticket prices"
[JPN] 実行例:
  node src/cli.js "バンクシー" "展示会のスケジュールとチケット価格の抽出" 3
...
================================================================================
    ...
    // 第2引数のintentが省略された場合、汎用的な抽出基準を自動でバインドします
    ...
    cliLogger.info(`Starting workflow... / ワークフローを開始します...`);
